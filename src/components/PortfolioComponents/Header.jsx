       ...
       <Link to='/'>
        ...
        <ul className='list-none sm:flex hidden justify-end items-center'>
            {navLinks.map((nav, index) => (
                <li key={nav.id} className={`text-[16px] cursor-pointer tracking-[2px] ${index === navLinks.length -1 ? 'mr-10' : 'mr-10'} text-white hover:text-terciary`}>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center mr-8'>
            <img src={toggle ? close : menu } alt='icon_menu' 
            ...
            <ul className='list-none flex flex-col items-center'>
                {navLinks.map((nav, index) => (
                    <li key={nav.id} className={`text-[16px] cursor-pointer tracking-[2px] ${index === navLinks.length -1 ? 'mr-0' : 'mb-10'} text-white`}>
